      ...
      <Popup>
        ...
        >
          <h3 className="text-center mb-3 laptop:text-left text-body-lg font-semibold laptop:mb-5">
            {type === 'create' ? 'Tạo địa chỉ mới' : 'Chỉnh sửa địa chỉ'}
          </h3>
          <div className="flex flex-col gap-4">
            <div className="flex gap-2">
              ...
              <Controller
                {...{
                  ...
                  placeholder: 'Họ tên',
                  className:
                    'border border-1 rounded-lg border-border_grey w-1/2 h-9 px-2 outline-primary/60 text-black',
            ...
            <Controller
              {...{
                ...
                className:
                  'border border-1 rounded-lg border-border_grey w-full h-9 px-2 outline-primary/60 text-black',
                handleChange: (e) => handleChange(e),
                options: province,
