...
function InfoItemList() {
  return (
    ...
    <section className="w-full">
      ...
      Điều gì làm cho thương hiệu của chúng tôi khác biệt
      </h4>
      {/* Feature item */}
      <div className="grid grid-cols-4 text-white tablet:grid-cols-6 gap-x-5 laptop:grid-cols-12 laptop:gap-y-5">
